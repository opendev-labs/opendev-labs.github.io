...
export const SyncStackConsole: React.FC = () => {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-black text-zinc-400 font-mono px-8 py-12 animate-in fade-in duration-700">
            {/* Context Header */}
            <div className="flex flex-col mb-8 max-w-[1400px] mx-auto w-full">
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div className="text-[10px] font-bold text-zinc-500 uppercase tracking-[0.3em]">
                        Product: <span className="text-white">SyncStack // Protocol Hub</span>
                    </div>
                </div>
            </div>

            <div className="flex flex-col flex-1 bg-black text-zinc-400 font-mono overflow-hidden border border-zinc-900 shadow-2xl max-w-[1400px] mx-auto w-full">
