...
import { Terminal, Database, Box, Cpu, Activity, Shield, Zap, ArrowUpRight, Search } from 'lucide-react';
...
export const MissionControl: React.FC = () => {
    ...
    return (
        <div className="max-w-[1400px] mx-auto p-12 md:p-24 animate-in fade-in duration-700">
            {/* Header Context */}
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-8">
                ...
                <div className="relative group">
                    ...
                    <input
                        ...
                        className="bg-zinc-900/50 border border-zinc-800 text-sm p-3 pl-12 w-64 text-white focus:outline-none focus:border-zinc-700 transition-colors placeholder:text-zinc-700"
                    />
                </div>
            </div>
