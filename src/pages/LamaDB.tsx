            ...
            <section className="relative min-h-[70vh] flex flex-col items-center justify-center pt-20 overflow-hidden border-b border-zinc-900">
                ...
                <div className="relative z-10 text-center max-w-4xl px-6">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        <Link to="/docs" className="w-full sm:w-auto h-12 px-8 rounded-full bg-black border border-zinc-800 text-white text-sm font-bold hover:bg-zinc-900 transition-all flex items-center justify-center">
                            Documentation
                        </Link>
                    </div>
                </div>
