...
import { SearchIcon as TaskStatusIcon, SpinnerIcon, CheckCircleIcon, NewChatIcon, PencilIcon, TrashIcon } from './icons/Icons';
...
export function GenerationStatusView({ info }: GenerationStatusViewProps) {
    ...
    return (
        <div className="mt-4 border border-white/10 rounded-lg p-3 bg-black/40">
